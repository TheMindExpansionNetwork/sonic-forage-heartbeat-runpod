...
Sidecars are produced by ``scripts/precompute_fixture_sidecars.py``
...
def fixture_sidecar(name: str, *, checkpoint: str) -> Optional[AudioSidecar]:
    ...
    return load_sidecar(json_path, sf_path, name=name, checkpoint=checkpoint)
