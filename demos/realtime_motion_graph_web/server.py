...
def _process_request(connection, request):
    ...
    # single picker. Uploads themselves arrive over the WebSocket (see
    # backend._handle_upload_track) since the websockets sync server's
    # process_request hook can't read POST bodies.
